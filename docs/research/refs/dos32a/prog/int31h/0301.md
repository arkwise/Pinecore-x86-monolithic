...
| **In:** | <br><br>**AX** = 0301h<br> **BH** = flags (must be 0)<br> **CX** = number of words to copy from protected mode to real mode stack<br> **ES:EDI **= selector:offset of real mode register data structure in the following format: <br><br> **Offset** |
|---|---|
